(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (find-file-in-project datomic-snippets angular-snippets buster-snippets ediprolog slime tagedit clj-refactor smart-forward smex browse-kill-ring multifiles change-inner jump-char multiple-cursors projectile perspective ido-completing-read+ clojure-mode f flx flycheck ansible systemd diff-hl less-css-mode typescript-mode cider yasnippet whitespace-cleanup-mode wgrep visual-regexp string-edit spinner smartparens simple-httpd restclient request queue prodigy paredit nodejs-repl move-text markdown-mode magit lorem-ipsum js2-mode inflections ido-vertical-mode ido-at-point hydra htmlize highlight-escape-sequences guide-key groovy-mode gist flycheck-pos-tip flx-ido fill-column-indicator exec-path-from-shell elm-mode elisp-slime-nav edn dockerfile-mode dired-details css-eldoc company clojure-mode-extra-font-locking beginend prolog-mode ediprolog)))
